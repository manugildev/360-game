...
public class ColorManager {
    ...
    public ColorManager() {
        ...
        // COLORS
        this.colors.add("EF717A");
        this.colors.add("5CFDDD");
        //this.colors.add("ECF0F1");
        this.colors.add("78FBB0");
        this.colors.add("74C7FF");
        this.colors.add("CF86ED");
        this.colors.add("7471F2");
        ...
        cb = new TweenCallback() {
            ...
            public void onEvent(int type, BaseTween<?> source) {
                ...
                rtime = randomGenarator.nextInt(5) + 4;
    ...
    public void update(float delta) {
        ...
        color = new Color(c1.getValue(), c2.getValue(), c3.getValue(), Settings.BACK_ALPHA);
    }
